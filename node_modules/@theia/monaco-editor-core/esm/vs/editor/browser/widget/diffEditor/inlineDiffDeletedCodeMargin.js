                ...
                getActions: () => {
                    ...
                    actions.push(new actions_1.Action('diff.clipboard.copyDeletedContent', isDeletion
                        ...
                        : (_diff.original.length > 1
                            ...
                            : (0, nls_1.localize)('diff.clipboard.copyChangedLinesContent.single.label', "Copy changed line")), undefined, true, () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (_diff.original.length > 1) {
                        actions.push(new actions_1.Action('diff.clipboard.copyDeletedLineContent', isDeletion
                            ...
                            : (0, nls_1.localize)('diff.clipboard.copyChangedLineContent.label', "Copy changed line ({0})", _diff.original.startLineNumber + currentLineNumberOffset), undefined, true, () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!readOnly) {
                        actions.push(new actions_1.Action('diff.inline.revertChange', (0, nls_1.localize)('diff.inline.revertChange.label', "Revert this change"), undefined, true, () => __awaiter(this, void 0, void 0, function* () {
