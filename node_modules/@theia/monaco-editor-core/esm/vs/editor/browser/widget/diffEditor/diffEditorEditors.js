...
let DiffEditorEditors = class DiffEditorEditors extends lifecycle_1.Disposable {
    ...
    _updateAriaLabel(ariaLabel) {
        ...
        const ariaNavigationTip = (0, nls_1.localize)('diff-aria-navigation-tip', ' use {0} to open the accessibility help.', (_a = this._keybindingService.lookupKeybinding('editor.action.accessibilityHelp')) === null || _a === void 0 ? void 0 : _a.getAriaLabel());
