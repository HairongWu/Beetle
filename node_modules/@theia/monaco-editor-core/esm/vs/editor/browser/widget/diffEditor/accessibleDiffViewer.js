    ...
    constructor(_element, _model, _width, _height, _editors, _languageService) {
        ...
        this._register((0, observable_1.autorun)(reader => {
            ...
            if (this._model.canClose.read(reader)) {
                this._actionBar.push(new actions_1.Action('diffreview.close', (0, nls_1.localize)('label.close', "Close"), 'close-diff-review ' + themables_1.ThemeIcon.asClassName(accessibleDiffViewerCloseIcon), true, () => __awaiter(this, void 0, void 0, function* () { return _model.close(); })), { label: false, icon: true });
            }
        }));
