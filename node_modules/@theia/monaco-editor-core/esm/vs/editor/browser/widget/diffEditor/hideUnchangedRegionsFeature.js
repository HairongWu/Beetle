...
let OutlineSource = class OutlineSource extends lifecycle_1.Disposable {
    constructor(_languageFeaturesService, _textModel) {
        ...
        this._register((0, observable_1.autorunWithStore)((reader, store) => __awaiter(this, void 0, void 0, function* () {
            documentSymbolProviderChanged.read(reader);
            textModelChanged.read(reader);
            const src = store.add(new utils_1.DisposableCancellationTokenSource());
            const model = yield outlineModel_1.OutlineModel.create(this._languageFeaturesService.documentSymbolProvider, this._textModel, src.token);
            if (store.isDisposed) {
                return;
            }
