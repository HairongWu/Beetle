...
export declare class MovedBlocksLinesPart extends Disposable {
    ...
    readonly width: import("../../../../base/common/observable").ISettableObservable<number, void>;
...
//# sourceMappingURL=movedBlocksLines.d.ts.map