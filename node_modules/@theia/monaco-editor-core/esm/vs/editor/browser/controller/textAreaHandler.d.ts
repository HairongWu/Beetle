...
export declare class TextAreaHandler extends ViewPart {
    ...
    constructor(context: ViewContext, viewController: ViewController, visibleRangeProvider: IVisibleRangeProvider, _keybindingService: IKeybindingService);
...
//# sourceMappingURL=textAreaHandler.d.ts.map