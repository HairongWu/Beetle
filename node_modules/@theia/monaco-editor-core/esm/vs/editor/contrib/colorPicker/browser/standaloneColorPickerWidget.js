...
const contentHover_1 = require("../../hover/browser/contentHover");
...
const defaultDocumentColorProvider_1 = require("./defaultDocumentColorProvider");
const dom = require("../../../../base/browser/dom");
require("./colorPicker.css");
let StandaloneColorPickerController = StandaloneColorPickerController_1 = class StandaloneColorPickerController extends lifecycle_1.Disposable {
...
let StandaloneColorPickerWidget = StandaloneColorPickerWidget_1 = class StandaloneColorPickerWidget extends lifecycle_1.Disposable {
    ...
    _computeAsync(range) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const colorHoverResult = yield this._standaloneColorPickerParticipant.createColorHover(colorInfo, new defaultDocumentColorProvider_1.DefaultDocumentColorProvider(this._modelService, this._languageConfigurationService), this._languageFeaturesService.colorProvider);
            if (!colorHoverResult) {
                return null;
            }
