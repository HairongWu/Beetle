...
const foldingModel_1 = require("./foldingModel");
const hiddenRangeModel_1 = require("./hiddenRangeModel");
const indentRangeProvider_1 = require("./indentRangeProvider");
const nls = require("../../../../nls");
const contextkey_1 = require("../../../../platform/contextkey/common/contextkey");
const foldingDecorations_1 = require("./foldingDecorations");
const foldingRanges_1 = require("./foldingRanges");
const syntaxRangeProvider_1 = require("./syntaxRangeProvider");
...
let FoldingController = FoldingController_1 = class FoldingController extends lifecycle_1.Disposable {
    static get(editor) {
    ...
    invoke(_foldingController, foldingModel, editor) {
        ...
        if (selections) {
            ...
            if (collapseRanges.length > 0) {
                ...
                const newRanges = foldingRanges_1.FoldingRegions.sanitizeAndMerge(foldingModel.regions, collapseRanges, (_a = editor.getModel()) === null || _a === void 0 ? void 0 : _a.getLineCount());
...
commands_1.CommandsRegistry.registerCommand('_executeFoldingRangeProvider', function (accessor, ...args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const ranges = yield rangeProvider.compute(cancellation_1.CancellationToken.None);
        const result = [];
        try {
            if (ranges) {
