...
export declare class StickyScrollWidget extends Disposable implements IOverlayWidget {
    ...
    setState(state: StickyScrollWidgetState | undefined, foldingModel: FoldingModel | null, rebuildFromLine?: number): void;
...
declare class RenderedStickyLine {
    ...
    constructor(index: number, lineNumber: number, lineDomNode: HTMLElement, lineNumberDomNode: HTMLElement, foldingIcon: StickyFoldingIcon | undefined, characterMapping: CharacterMapping);
}
