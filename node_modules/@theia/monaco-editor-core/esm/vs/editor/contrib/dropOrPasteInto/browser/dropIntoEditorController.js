...
let DropIntoEditorController = DropIntoEditorController_1 = class DropIntoEditorController extends lifecycle_1.Disposable {
    ...
    onDropIntoEditor(editor, position, dragEvent) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const p = (0, async_1.createCancelablePromise)((token) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    if (edits.length) {
                        ...
                        yield this._postDropWidgetManager.applyEditAndShowIfNeeded([range_1.Range.fromPositions(position)], { activeEditIndex, allEdits: edits }, canShowWidget, token);
                    }
                }
                finally {
                    tokenSource.dispose();
    ...
    getDropEdits(providers, model, position, dataTransfer, tokenSource) {
        return __awaiter(this, void 0, void 0, function* () {
            const results = yield (0, async_1.raceCancellation)(Promise.all(providers.map((provider) => __awaiter(this, void 0, void 0, function* () {
                try {
