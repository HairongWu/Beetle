...
let ContentHoverWidget = ContentHoverWidget_1 = class ContentHoverWidget extends resizableContentWidget_1.ResizableContentWidget {
    ...
    showAt(node, hoverData) {
        ...
        const accessibleViewHint = (0, hoverWidget_1.getHoverAccessibleViewHint)(this._configurationService.getValue('accessibility.verbosity.hover') === true && this._accessibilityService.isScreenReaderOptimized(), (_d = (_c = this._keybindingService.lookupKeybinding('editor.action.accessibleView')) === null || _c === void 0 ? void 0 : _c.getAriaLabel()) !== null && _d !== void 0 ? _d : '');
