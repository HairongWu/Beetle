...
class FindOptionsWidget extends widget_1.Widget {
    constructor(editor, state, keybindingService) {
        ...
        this.caseSensitive = this._register(new findInputToggles_1.CaseSensitiveToggle(Object.assign({ appendTitle: this._keybindingLabelFor(findModel_1.FIND_IDS.ToggleCaseSensitiveCommand), isChecked: this._state.matchCase }, toggleStyles)));
        ...
        this.wholeWords = this._register(new findInputToggles_1.WholeWordsToggle(Object.assign({ appendTitle: this._keybindingLabelFor(findModel_1.FIND_IDS.ToggleWholeWordCommand), isChecked: this._state.wholeWord }, toggleStyles)));
        ...
        this.regex = this._register(new findInputToggles_1.RegexToggle(Object.assign({ appendTitle: this._keybindingLabelFor(findModel_1.FIND_IDS.ToggleRegexCommand), isChecked: this._state.isRegex }, toggleStyles)));
