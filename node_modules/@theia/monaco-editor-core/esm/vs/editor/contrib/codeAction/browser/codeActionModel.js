    ...
    _update() {
        ...
        if (model
            ...
            this._codeActionOracle.value = new CodeActionOracle(this._editor, this._markerService, trigger => {
                ...
                const actions = (0, async_1.createCancelablePromise)((token) => __awaiter(this, void 0, void 0, function* () {
                    var _b, _c, _d, _e, _f, _g;
                    if (this._settingEnabledNearbyQuickfixes() && trigger.trigger.type === 1 /* CodeActionTriggerType.Invoke */ && (trigger.trigger.triggerAction === types_1.CodeActionTriggerSource.QuickFix || ((_c = (_b = trigger.trigger.filter) === null || _b === void 0 ? void 0 : _b.include) === null || _c === void 0 ? void 0 : _c.contains(types_1.CodeActionKind.QuickFix)))) {
                        const codeActionSet = yield (0, codeAction_1.getCodeActions)(this._registry, model, trigger.selection, trigger.trigger, progress_1.Progress.None, token);
                        if (token.isCancellationRequested) {
                            return emptyCodeActionSet;
                        }
                        // Search for quickfixes in the curret code action set.
                        const foundQuickfix = (_d = codeActionSet.validActions) === null || _d === void 0 ? void 0 : _d.some(action => action.action.kind ? types_1.CodeActionKind.QuickFix.contains(new types_1.CodeActionKind(action.action.kind)) : false);
                        if (!foundQuickfix) {
                            ...
                            if (allMarkers.length > 0) {
                                ...
                                if (toBeModified) {
                                    const newCodeActionTrigger = {
                                        ...
                                        filter: { include: ((_e = trigger.trigger.filter) === null || _e === void 0 ? void 0 : _e.include) ? (_f = trigger.trigger.filter) === null || _f === void 0 ? void 0 : _f.include : types_1.CodeActionKind.QuickFix },
                                    ...
                                    const actionsAtMarker = yield (0, codeAction_1.getCodeActions)(this._registry, model, selectionAsPosition, newCodeActionTrigger, progress_1.Progress.None, token);
