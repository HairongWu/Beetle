...
const actionWidget_1 = require("../../../../platform/actionWidget/browser/actionWidget");
...
let CodeActionController = CodeActionController_1 = class CodeActionController extends lifecycle_1.Disposable {
    static get(editor) {
    ...
    _applyCodeAction(action, retrigger, preview) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this._instantiationService.invokeFunction(codeAction_1.applyCodeAction, action, codeAction_1.ApplyCodeActionReason.FromCodeActions, { preview, editor: this._editor });
            }
            finally {
                if (retrigger) {
            ...
            if (newState.trigger.type === 1 /* CodeActionTriggerType.Invoke */) {
                if ((_c = newState.trigger.filter) === null || _c === void 0 ? void 0 : _c.include) { // Triggered for specific scope
                    ...
                    if (newState.trigger.context) {
                        ...
                        if (invalidAction && invalidAction.action.disabled) {
                            (_e = messageController_1.MessageController.get(this._editor)) === null || _e === void 0 ? void 0 : _e.showMessage(invalidAction.action.disabled, newState.trigger.context.position);
                            actions.dispose();
                            return;
                        }
                    }
                ...
                if (newState.trigger.context) {
                    if (!actions.allActions.length || !includeDisabledActions && !actions.validActions.length) {
                        (_g = messageController_1.MessageController.get(this._editor)) === null || _g === void 0 ? void 0 : _g.showMessage(newState.trigger.context.notAvailableMessage, newState.trigger.context.position);
...
CodeActionController.DECORATION = textModel_1.ModelDecorationOptions.register({
