...
export declare class CustomizedMenuWorkbenchToolBar extends WorkbenchToolBar {
    ...
    constructor(container: HTMLElement, menuId: MenuId, options2: IMenuWorkbenchToolBarOptions | undefined, menuService: IMenuService, contextKeyService: IContextKeyService, contextMenuService: IContextMenuService, keybindingService: IKeybindingService, telemetryService: ITelemetryService);
