...
const inlineCompletionsHintsWidget_1 = require("./inlineCompletionsHintsWidget");
...
let InlineCompletionsHoverParticipant = class InlineCompletionsHoverParticipant {
    ...
    renderHoverParts(context, hoverParts) {
        ...
        const w = this._instantiationService.createInstance(inlineCompletionsHintsWidget_1.InlineSuggestionHintsContentWidget, this._editor, false, (0, observable_1.constObservable)(null), model.selectedInlineCompletionIndex, model.inlineCompletionsCount, model.selectedInlineCompletion.map(v => { var _a; return (_a = v === null || v === void 0 ? void 0 : v.inlineCompletion.source.inlineCompletions.commands) !== null && _a !== void 0 ? _a : []; }));
