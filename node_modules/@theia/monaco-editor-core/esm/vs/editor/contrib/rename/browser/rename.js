...
let RenameController = RenameController_1 = class RenameController {
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.editor.focus();
            const renameOperation = (0, async_1.raceCancellation)(skeleton.provideRenameEdits(inputFieldResult.newName, cts2.token), cts2.token).then((renameResult) => __awaiter(this, void 0, void 0, function* () {
