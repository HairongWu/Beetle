...
let SmartSelectController = SmartSelectController_1 = class SmartSelectController {
    ...
    run(forward) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this._state) {
                yield provideSelectionRanges(this._languageFeaturesService.selectionRangeProvider, model, selections.map(s => s.getPosition()), this._editor.getOption(112 /* EditorOption.smartSelect */), cancellation_1.CancellationToken.None).then(ranges => {
                    var _a;
