...
import { AttachedViews, TextModel } from './textModel';
...
export declare class TokenizationTextModelPart extends TextModelPart implements ITokenizationTextModelPart {
    ...
    private readonly grammarTokens;
    constructor(_languageService: ILanguageService, _languageConfigurationService: ILanguageConfigurationService, _textModel: TextModel, _bracketPairsTextModelPart: BracketPairsTextModelPart, _languageId: string, _attachedViews: AttachedViews);
