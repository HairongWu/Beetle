...
export declare const ILanguageFeatureDebounceService: import("../../../platform/instantiation/common/instantiation").ServiceIdentifier<ILanguageFeatureDebounceService>;
...
//# sourceMappingURL=languageFeatureDebounce.d.ts.map