...
class StandaloneDialogService {
    ...
    info(message, detail) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.prompt({ type: severity_1.default.Info, message, detail });
        });
    }
    warn(message, detail) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.prompt({ type: severity_1.default.Warning, message, detail });
        });
    }
    error(message, detail) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.prompt({ type: severity_1.default.Error, message, detail });
        });
    }
    input() {
