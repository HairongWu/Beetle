        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve) => {
                ...
                if (!this.options.disableCloseAction) {
                    ...
                    const action = this._register(new actions_1.Action('dialog.close', nls.localize('dialogClose', "Close Dialog"), themables_1.ThemeIcon.asClassName(codicons_1.Codicon.dialogClose), true, () => __awaiter(this, void 0, void 0, function* () {
                        resolve({
                            button: this.options.cancelId || 0,
                            checkboxChecked: this.checkbox ? this.checkbox.checked : undefined
                        });
