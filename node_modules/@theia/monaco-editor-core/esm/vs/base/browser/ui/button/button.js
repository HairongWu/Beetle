...
class ButtonWithDropdown extends lifecycle_1.Disposable {
    constructor(container, options) {
        ...
        this.action = this._register(new actions_1.Action('primaryAction', (0, markdownRenderer_1.renderStringAsPlaintext)(this.button.label), undefined, true, () => __awaiter(this, void 0, void 0, function* () { return this._onDidClick.fire(undefined); })));
