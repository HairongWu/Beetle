...
class FindInput extends widget_1.Widget {
    constructor(parent, contextViewProvider, options) {
        ...
        if (this.showCommonFindToggles) {
            this.regex = this._register(new findInputToggles_1.RegexToggle(Object.assign({ appendTitle: appendRegexLabel, isChecked: false }, options.toggleStyles)));
            ...
            this.wholeWords = this._register(new findInputToggles_1.WholeWordsToggle(Object.assign({ appendTitle: appendWholeWordsLabel, isChecked: false }, options.toggleStyles)));
            ...
            this.caseSensitive = this._register(new findInputToggles_1.CaseSensitiveToggle(Object.assign({ appendTitle: appendCaseSensitiveLabel, isChecked: false }, options.toggleStyles)));
