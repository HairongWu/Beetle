...
export declare const registerWindow: (window: Window) => IDisposable, getWindows: () => Window[], onDidCreateWindow: event.Event<{
    window: Window;
...
export declare function createStyleSheet(container?: HTMLElement, beforeAppend?: (style: HTMLStyleElement) => void): HTMLStyleElement;
