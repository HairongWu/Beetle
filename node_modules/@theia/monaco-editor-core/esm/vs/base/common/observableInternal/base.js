...
class TransactionImpl {
    constructor(_fn, _getDebugName) {
        ...
        (_a = (0, logging_1.getLogger)()) === null || _a === void 0 ? void 0 : _a.handleBeginTransaction(this);
    }
    getDebugName() {
    ...
    finish() {
        ...
        (_a = (0, logging_1.getLogger)()) === null || _a === void 0 ? void 0 : _a.handleEndTransaction();
    }
}
...
class ObservableValue extends BaseObservable {
    ...
    set(value, tx, change) {
        ...
        try {
            ...
            (_a = (0, logging_1.getLogger)()) === null || _a === void 0 ? void 0 : _a.handleObservableChanged(this, { oldValue, newValue: value, change, didChange: true, hadValue: true });
