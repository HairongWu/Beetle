...
function derivedWithStore(computeFnOrOwner, computeFnOrUndefined) {
    ...
    return new Derived(owner, (() => { var _a; return (_a = (0, base_1.getFunctionName)(computeFn)) !== null && _a !== void 0 ? _a : '(anonymous)'; }), r => {
        store.clear();
...
class Derived extends base_1.BaseObservable {
    get debugName() {
        var _a;
        return (_a = (0, base_1.getDebugName)(this._debugName, this._computeFn, this._owner, this)) !== null && _a !== void 0 ? _a : '(anonymous)';
    }
