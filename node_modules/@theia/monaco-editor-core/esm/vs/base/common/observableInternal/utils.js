...
class FromEventObservable extends base_1.BaseObservable {
    constructor(event, _getValue) {
        ...
        this.handleEvent = (args) => {
            ...
            (_a = (0, logging_1.getLogger)()) === null || _a === void 0 ? void 0 : _a.handleFromEventObservableTriggered(this, { oldValue: this.value, newValue, change: undefined, didChange, hadValue: this.hasValue });
            if (didChange) {
                this.value = newValue;
                if (this.hasValue) {
...
class ObservableSignal extends base_1.BaseObservable {
    get debugName() {
        var _a;
        return (_a = (0, base_1.getDebugName)(this._debugName, undefined, this._owner, this)) !== null && _a !== void 0 ? _a : 'Observable Signal';
    }
