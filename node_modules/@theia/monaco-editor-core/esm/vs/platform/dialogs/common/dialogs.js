...
exports.massageMessageBoxOptions = exports.getFileNamesMessage = exports.IFileDialogService = exports.AbstractDialogHandler = exports.IDialogService = void 0;
...
function massageMessageBoxOptions(options, productService) {
    ...
    let buttons = ((_a = massagedOptions.buttons) !== null && _a !== void 0 ? _a : []).map(button => (0, labels_1.mnemonicButtonLabel)(button));
