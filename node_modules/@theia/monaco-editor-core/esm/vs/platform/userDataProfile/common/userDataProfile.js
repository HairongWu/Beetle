...
exports.InMemoryUserDataProfilesService = exports.UserDataProfilesService = exports.toUserDataProfile = exports.reviveProfile = exports.IUserDataProfilesService = exports.isUserDataProfile = void 0;
...
function toUserDataProfile(id, name, location, profilesCacheHome, options, defaultProfile) {
    ...
    return {
        ...
        globalStorageHome: defaultProfile && ((_a = options === null || options === void 0 ? void 0 : options.useDefaultFlags) === null || _a === void 0 ? void 0 : _a.globalState) ? defaultProfile.globalStorageHome : (0, resources_1.joinPath)(location, 'globalStorage'),
        settingsResource: defaultProfile && ((_b = options === null || options === void 0 ? void 0 : options.useDefaultFlags) === null || _b === void 0 ? void 0 : _b.settings) ? defaultProfile.settingsResource : (0, resources_1.joinPath)(location, 'settings.json'),
        keybindingsResource: defaultProfile && ((_c = options === null || options === void 0 ? void 0 : options.useDefaultFlags) === null || _c === void 0 ? void 0 : _c.keybindings) ? defaultProfile.keybindingsResource : (0, resources_1.joinPath)(location, 'keybindings.json'),
        tasksResource: defaultProfile && ((_d = options === null || options === void 0 ? void 0 : options.useDefaultFlags) === null || _d === void 0 ? void 0 : _d.tasks) ? defaultProfile.tasksResource : (0, resources_1.joinPath)(location, 'tasks.json'),
        snippetsHome: defaultProfile && ((_e = options === null || options === void 0 ? void 0 : options.useDefaultFlags) === null || _e === void 0 ? void 0 : _e.snippets) ? defaultProfile.snippetsHome : (0, resources_1.joinPath)(location, 'snippets'),
        extensionsResource: defaultProfile && ((_f = options === null || options === void 0 ? void 0 : options.useDefaultFlags) === null || _f === void 0 ? void 0 : _f.extensions) ? defaultProfile.extensionsResource : (0, resources_1.joinPath)(location, 'extensions.json'),
...
let UserDataProfilesService = class UserDataProfilesService extends lifecycle_1.Disposable {
    ...
    getProfileForWorkspace(workspaceIdentifier) {
        ...
        return uri_1.URI.isUri(workspace) ? (_a = this.transientProfilesObject.workspaces.get(workspace)) !== null && _a !== void 0 ? _a : this.profilesObject.workspaces.get(workspace) : (_b = this.transientProfilesObject.emptyWindows.get(workspace)) !== null && _b !== void 0 ? _b : this.profilesObject.emptyWindows.get(workspace);
    }
