...
import { IActionListDelegate, IActionListItem } from './actionList';
export declare const IActionWidgetService: import("../../instantiation/common/instantiation").ServiceIdentifier<IActionWidgetService>;
