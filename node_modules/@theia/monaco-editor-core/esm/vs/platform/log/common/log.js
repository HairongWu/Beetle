...
class AbstractLoggerService extends lifecycle_1.Disposable {
    ...
    createLogger(idOrResource, options) {
        ...
        const id = (0, types_1.isString)(idOrResource) ? idOrResource : ((_a = options === null || options === void 0 ? void 0 : options.id) !== null && _a !== void 0 ? _a : (0, hash_1.hash)(resource.toString()).toString(16));
