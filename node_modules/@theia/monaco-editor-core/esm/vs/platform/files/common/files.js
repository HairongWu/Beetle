...
function getLargeFileConfirmationLimit(arg) {
    const isRemote = typeof arg === 'string' || (arg === null || arg === void 0 ? void 0 : arg.scheme) === network_1.Schemas.vscodeRemote;
    const isLocal = typeof arg !== 'string' && (arg === null || arg === void 0 ? void 0 : arg.scheme) === network_1.Schemas.file;
    if (isLocal) {
