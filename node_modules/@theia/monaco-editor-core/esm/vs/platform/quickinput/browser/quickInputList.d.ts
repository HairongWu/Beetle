...
import { IQuickPickItem, IQuickPickItemButtonEvent, IQuickPickSeparatorButtonEvent, QuickPickItem } from '../common/quickInput';
...
export declare class QuickInputList {
    ...
    onLeave: Event<void>;
    private readonly _listElementChecked;
    private _fireCheckedEvents;
    private elementDisposables;
    private disposables;
    private _lastHover;
    private _toggleHover;
    constructor(parent: HTMLElement, id: string, options: IQuickInputOptions, themeService: IThemeService);
